...
Este repositório faz parte da Imersão Dev, um *bootcamp* da Alura composto de 10 aulas, lecionado pelo CEO Paulo Silveira; a instrutora de *front-end* Rafaella Ballerini e o Desenvolvedor Guilherme Lima.  O desafio consta em criar uma simples programas utilizando a tecnologia **JavaScript**, juntamente com **HTML** e **CSS** no software Visual Studio Code. 
